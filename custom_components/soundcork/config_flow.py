...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        vol.Required(CONF_BASE_URL, default="http://192.168.1.229:8000"): str,
    }
)


async def validate_input(hass: HomeAssistant, data: dict[str, Any]) -> dict[str, Any]:
    """Validate the user input by connecting to SoundCork and fetching speakers."""
...
class SoundCorkConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for SoundCork."""
...
class NoSpeakers(Exception):
    """Error to indicate no speakers were found."""
